...
train = pd.read_csv(r"D:\CampusX\Flight_Sagemaker_Project\data\train.csv")
...
)).astype({                          # pd.datetime function won't work on strealit so converting into str
    col: 'str'
...
if st.button('Predict'):
    ...
    pred = model.predict(x_new_xgb)[0] #model return array of one value but we need it in scalar value, using[0]
